    ...
    const brandProfile = await this.brandProfilesRepository.create(
      {
        ...
        primaryFont: dto.primaryFont ?? null,
        productsAndServices: dto.productsAndServices ?? null,
        mission: dto.mission ?? null,
        vision: dto.vision ?? null,
        primaryCTA: dto.primaryCTA ?? null,
  ...
  async update(id: string, dto: UpdateBrandProfileDto, actorId?: string): Promise<BrandProfile> {
    ...
    return this.brandProfilesRepository.update(
      id,
      {
        ...
        productsAndServices: dto.productsAndServices,
        mission: dto.mission,
        vision: dto.vision,
